...
namespace FishingPlace.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ContactInfo")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ContactInfo")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
